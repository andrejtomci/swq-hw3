...
echo "Trying both in one command:"
java -classpath brainmethodcheck-1.0.jar:checkstyle-8.42-all.jar com.puppycrawl.tools.checkstyle.Main -c mychecks.xml *.java
